...
const SolutionsMenu = () => (
  <div className='grid gap-8 sm:grid-cols-2'>
    ...
    <div className='col-span-full grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4 lg:gap-8'>
      {jewelry.map((jewelry) => (
        <div key={jewelry.id} className='rounded-md border border-border p-5'>
          <div className='border-b border-border pb-4'>
            ...
            >
              <div className='flex items-center'>
                <strong className='text-sm font-medium'>{jewelry.title}</strong>
                <ArrowRight className='ml-1 size-4 transition-transform group-hover:translate-x-1' />
              </div>
    ...
    <div className='lg:col-span-2 lg:flex lg:flex-col'>
      ...
      <menu className='grid gap-y-4 lg:h-full lg:grid-cols-2 lg:gap-6'>
        {forhims.map((forhim) => (
          ...
          >
            <forhim.icon className='size-6 sm:size-7' />
        ...
        <NavigationMenu className='min-w-full bg-red-800 '>
          ...
          {open && (
            <div className='fixed inset-0 top-[72px] flex h-[calc(100vh-72px)] w-full flex-col overflow-scroll border-t border-border bg-background lg:hidden'>
              ...
              {submenu === null && (
                <div>
                  <button
                    ...
                    onClick={() => setSubmenu('jewelry')}
                  >
                    <span className='flex-1 text-sm font-medium'>Jewelry</span>
                  ...
                  <button
                    type='button'
                    className='flex w-full items-center border-b border-border px-8 py-6 text-left'
                    onClick={() => setSubmenu('nailart')}
                  >
                    <span className='flex-1 text-sm font-medium'>Nail Art</span>
                    <span className='shrink-0'>
                      <ArrowRight className='size-4' />
                    </span>
                  </button>
                  <button
                    type='button'
                    className='flex w-full items-center border-b border-border px-8 py-6 text-left'
                    onClick={() => setSubmenu('forhims')}
                  >
                    <span className='flex-1 text-sm font-medium'>For Him</span>
                    <span className='shrink-0'>
                      <ArrowRight className='size-4' />
                    </span>
                  </button>
              ...
              {submenu === 'brand' && (
                <div className='container'>
                  <h2 className='pb-6 pt-4 text-lg font-medium'>Our Brands</h2>
                  <GlobalBrandMenu />
                </div>
              )}
              {submenu === 'customers' && (
                <div className='container'>
                  <h2 className='pb-6 pt-4 text-lg font-medium'>Nail Polish</h2>
                  <CustomersMenu />
                </div>
              )}
              {submenu === 'nailart' && (
                <div className='container'>
                  <h2 className='pb-6 pt-4 text-lg font-medium'>Nail Art</h2>
                  <NailArtMenu />
                </div>
              )}
              {submenu === 'forhims' && (
                <div className='container'>
                  <h2 className='pb-6 pt-4 text-lg font-medium'>For Him</h2>
                  <ResourcesMenu />
                </div>
              )}
              {/* Mobile menu footer */}
